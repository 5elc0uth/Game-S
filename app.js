...
day_night2.addEventListener('click', ()=>{
    ...
    document.documentElement.style.setProperty('--color-3', 'black');
    document.documentElement.style.setProperty('--color-4', 'rgb(225,225,225,.5');
...
let audio1 = new Audio('audio/samsung.mp3');
// audio.play();
